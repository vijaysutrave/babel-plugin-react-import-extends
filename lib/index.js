...
exports.default = function (_ref) {
  ...
  return {
    visitor: {
      ...
      ClassDeclaration: function ClassDeclaration(classPath, state) {
      ...
      Program: {
        exit: function exit(path) {
          ...
          var reactImport = t.importDeclaration([t.importDefaultSpecifier(t.identifier('React')), t.importSpecifier(t.identifier(extendsFrom), t.identifier(extendsFrom)), t.importSpecifier(t.identifier('PropTypes'), t.identifier('PropTypes'))], t.stringLiteral('react'));
